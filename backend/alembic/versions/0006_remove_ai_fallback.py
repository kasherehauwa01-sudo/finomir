"""Удаление настроек и журнала отключенного AI fallback."""
...
def upgrade():
    # IF EXISTS позволяет безопасно обновить инсталляции, где 0005 была
    # отмечена примененной после частично завершившегося развертывания.
    op.execute("DROP TABLE IF EXISTS ai_fallback_logs")
