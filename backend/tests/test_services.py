...
import pytest
from app.services.finance import allocation_totals,distribute_evenly,expense_totals,invoice_totals
...
def test_even_distribution_keeps_every_cent(): assert distribute_evenly(Decimal("100.00"),3)==[Decimal("33.34"),Decimal("33.33"),Decimal("33.33")]
