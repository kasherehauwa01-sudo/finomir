...
export function DirectoryCard() {
  ...
  async function save(event: FormEvent<HTMLFormElement>) {
    ...
    if (isPartner && partner) {
      ...
      const updated = await api<Counterparty>(`/counterparties/${itemId}`, { method: 'PUT', body: JSON.stringify({ partner_id: data.get('partner_id'), full_name: data.get('full_name'), entity_type: counterparty.entity_type, inn: data.get('inn') || null, kpp: data.get('kpp') || null, comment: data.get('comment') || null }) });
