...
export function Expenses() {
  ...
  const updateCounterpartyFilter = (next: string[]) => { setCounterpartyIds(next); setPage(1); setSelectedIds([]); };
  const updatePartnerFilter = (next: string[]) => { setPartnerIds(next);setCounterpartyIds((current)=>compatibleCounterpartyIds(current,next,counterparties));setPage(1);setSelectedIds([]); };
