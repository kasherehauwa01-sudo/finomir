...
export type DashboardSummary = { invoice_total: string; paid_total: string; remaining_total: string; expense_count: number; period: 'month' | 'quarter' | 'year'; expense_trend: { period: string; label: string; amount: string }[]; tag_totals: { tag: string; amount: string; expense_count: number }[] };
