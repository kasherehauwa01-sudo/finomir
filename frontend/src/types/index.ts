export type Expense = { id: string; period: string; partner: string; counterparty: string; stores: { name: string; amount: string }[]; tags: string[]; has_invoice_document: boolean; has_closing_document: boolean; is_cash: boolean; invoice_number: string; invoice_date: string; service_name: string; invoice_total: string; paid_total: string; remaining_total: string; updated_at: string };
...
export type Partner = { id: string; name: string; comment?: string | null; tag_id?: string | null };
